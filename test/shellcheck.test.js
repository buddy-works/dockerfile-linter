...
import { ERROR_LEVELS, getDisplayErrors, cleanDisplayErrors } from '../lib/errors.js';
...
describe('Shellcheck functions', () => {
    describe('Using shellcheck linter', () => {
        ...
        it('Add errors and return promises array', async function () {
            const parsedFile = {
                groups: [
                    {
                        instruction: 'RUN',
            ...
            await Promise.all(shellCheck(parsedFile, 'sh'));
        ...
        it("Don't add errors and return promises array", async function () {
            const parsedFile = {
                groups: [
                    {
                        instruction: 'RUN',
