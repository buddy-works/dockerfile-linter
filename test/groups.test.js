...
import { groupLinesByInstruction, groupByCommand } from '../lib/groups.js';
        ...
        it('Return array of groups', () => {
            ...
            expect(groupLinesByInstruction(lines, '\\')).to.deep.equal([
                ...
                [
                    ...
                    {
                        lineNumber: 4,
                        text: '&& useradd --uid 1000 --gid node --shell /bin/bash --create-home node',
                    },
                ],
                ...
                [
                    ...
                    {
                        lineNumber: 14,
                        text: 'gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ; \\',
                    },
                    ...
                    {
                        lineNumber: 21,
                        text: '&& ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn \\',
                    },
                    {
                        lineNumber: 22,
                        text: '&& ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg \\',
                    },
                    {
                        lineNumber: 23,
                        text: '&& rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz',
                    },
                ],
